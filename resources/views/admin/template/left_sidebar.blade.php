                ...
                <li  class="has-sub active expand" >
                    ...
                    <ul  class="collapse show"  id="dashboard"
                        ...
                        <div class="sub-menu">
                            ...
                            <li>
                                <a class="sidenav-item-link" href="{{ route('admin.genre.index') }}">
                            ...
                            <li>
                                <a class="sidenav-item-link" href="{{ route('admin.tag.index') }}">
                            ...
                            <li >
                                <a class="sidenav-item-link" href="{{ route('admin.data.create') }}">
